...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["loanapplications-loanapplications-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLoanapplicationsLoanapplicationListLoanappFilterSettingsLoanappFilterSettingsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLoanapplicationsLoanapplicationListLoanapplicationListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLoanapplicationsLoanapplicationListLoanapplicationTableLoanapplicationTableComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanApplicationListService", function () {
      return LoanApplicationListService;
    });
    /* harmony import */
    ...
    var _loanapplication_interface__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var LoanApplicationListService =
    /*#__PURE__*/
    function () {
      function LoanApplicationListService(http, serverStatusSrv) {
        var _this = this;

        _classCallCheck(this, LoanApplicationListService);
        ...
        this.curLoanApplicationList$ = this.curLoanApplicationListSub$.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(_loanapplication_interface__WEBPACK_IMPORTED_MODULE_5__["WrongLoanApplicationList"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(1));
        ...
        this.curLoanApplicationList$.subscribe(function (loanApplications) {
          _this.curLoanApplicationList = loanApplications;
        });
      } // ------------------------------------------------------------


      _createClass(LoanApplicationListService, [{
        key: "isWrongLoanApplicationList",
        value: function isWrongLoanApplicationList(loanApplications) {
          if (!loanApplications) {
        ...
        key: "isLoanApplicationListNotEmpty",
        value: function isLoanApplicationListNotEmpty(loanApplications) {
          if (!loanApplications) {
            throw new Error('Parameter [loanApplications] is null');
          }
        ...
        key: "isLoanApplicationListEmpty",
        value: function isLoanApplicationListEmpty() {
          return !this.isLoanApplicationListNotEmpty(this.curLoanApplicationList);
        }
      }, {
        key: "clearLoanApplicationList",
        value: function clearLoanApplicationList() {
        ...
        key: "loadLoanApplicationList",
        value: function loadLoanApplicationList(stateService) {
          var _this2 = this;

          // console.log('SYNC ENTER LoanApplicationListService.loadLoanApplicationList() %O', stateService);
          if (stateService) {
            var isLoanApplicationsChangedEnter = {
          ...
          this.http.get("".concat(this.apiUrl, "/loanapplications"), {
            ...
            var curLoanApplicationList = loanApplications.map(function (item) {
              var loanApplication = {
            ...
            if (err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]) {
              ...
              ;
              isLoanApplicationsChangedError.messageType = _shared_model_entity_state_interface__WEBPACK_IMPORTED_MODULE_6__["EntityMessageTypeEnum"].ERROR;
              isLoanApplicationsChangedError.message = "LOANAPPLICATION ERROR: ".concat(msg);
            }
            ...
            _this2.clearLoanApplicationList();
            ...
            // } else
            if (rezObj.token === 'OK') {
              _this2.curLoanApplicationListSub$.next(rezObj.loanApplications); // BEFOR stateService.next()!


              if (stateService) {
                var isLoanApplicationsChangedExit = {
                  op: _shared_model_entity_state_interface__WEBPACK_IMPORTED_MODULE_6__["EntityStateEnum"].LOAD,
                  isEnd: true,
    ...
    LoanApplicationListService.ctorParameters = function () {
      return [{
    ...
    LoanApplicationListService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanappFilterSettingsLoanappFilterSettingsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanappFilterSettingsLoanappFilterSettingsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanappFilterSettingsComponent", function () {
      return LoanappFilterSettingsComponent;
    });
    /* harmony import */
    ...
    var LoanappFilterSettingsComponent =
    /*#__PURE__*/
    function () {
      function LoanappFilterSettingsComponent() {
        _classCallCheck(this, LoanappFilterSettingsComponent);

        this.loanApplicationViewChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this._renderLoanApplicationArr = null; // public OfficerList = CREDIT_OFFICER_LIST;
      ...
      _createClass(LoanappFilterSettingsComponent, [{
        key: "ngOnInit",
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('data-source')], LoanappFilterSettingsComponent.prototype, "loanApplicationArr", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('loanapplication-view-change')], LoanappFilterSettingsComponent.prototype, "loanApplicationViewChange", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('render-data')], LoanappFilterSettingsComponent.prototype, "renderLoanApplicationArr", null);
    LoanappFilterSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-loanapp-filter-settings',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./loanapp-filter-settings.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/loanapplications/loanapplication-list/loanapp-filter-settings/loanapp-filter-settings.component.html")).default,
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./loanapp-filter-settings.component.scss */
      "./src/app/loanapplications/loanapplication-list/loanapp-filter-settings/loanapp-filter-settings.component.scss")).default]
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanapplicationListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanapplicationListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanApplicationListComponent", function () {
      return LoanApplicationListComponent;
    });
    /* harmony import */
    ...
    var _loanapplication_list_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../loanapplication-list.service */
    "./src/app/loanapplications/loanapplication-list.service.ts");

    var LoanApplicationListComponent =
    /*#__PURE__*/
    function () {
      function LoanApplicationListComponent(router, userSrv, loanApplicationsSrv, loanApplicationsStateSrv, snackBarSrv) {
        _classCallCheck(this, LoanApplicationListComponent);

        this.router = router;
        this.userSrv = userSrv;
        this.loanApplicationsSrv = loanApplicationsSrv;
        this.loanApplicationsStateSrv = loanApplicationsStateSrv;
        this.snackBarSrv = snackBarSrv; // @ViewChild(LoanApplicationTableComponent, {static: false}) loanApplicationTableCmp: LoanApplicationTableComponent;

        this.currentUser$ = null;
        this.currentLoanApplications$ = null; // public curLoanApplicationList$: Observable<LoanApplicationInterface[]> = null;
        // --------------------------------------------------------------
      ...
      _createClass(LoanApplicationListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this3 = this;
          ...
          this.currentUser$ = this.userSrv.curUser$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (user) {
            ...
            if (_this3.userSrv.isAnonymUser(user)) {
              ...
              _this3.loanApplicationsSrv.clearLoanApplicationList(); // this.onDestroySub$.next(true);

            }
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.onDestroySub$));
          this.currentLoanApplications$ = this.loanApplicationsSrv.curLoanApplicationList$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (loanApplications) {
            // console.log(`\tPIPE: LoanApplicationListComponent.OnInit() tap currentLoanApplications$:%O`, loanapplications,);
            if (_this3.loanApplicationsSrv.isWrongLoanApplicationList(loanApplications)) {
              if (_this3.userSrv.isCurUserAuth()) {
                _this3.loanApplicationsSrv.loadLoanApplicationList(_this3.loanApplicationsStateSrv);
              }
            }
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (loanApplications) {
          ...
          this.isLoanApplicationsChanged$ = this.loanApplicationsStateSrv.isEntityChanged$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (r) {
            ...
            if (r.op === _shared_model_entity_state_interface__WEBPACK_IMPORTED_MODULE_6__["EntityStateEnum"].NOSET) {
              ...
              if (!r.isEnd && r.opResult === _shared_model_entity_state_interface__WEBPACK_IMPORTED_MODULE_6__["EntityChangeResultEnum"].NOSET) {
                ...
                _this3.simpleSnackBarRef = _this3.snackBarSrv.open("Selected Loan Application has been deleted!", 'X', {
                  duration: 0,
        ...
        key: "loanApplicationViewChanged",
        value: function loanApplicationViewChanged(ev) {
          // console.log('LoanApplicationListComponent.loanApplicationViewChanged(ev) view=%s', ev);
          this.loanApplicationView = ev;
        }
      }, {
        key: "renderLoanApplicationsChanged",
        value: function renderLoanApplicationsChanged(ev) {
    ...
    LoanApplicationListComponent.ctorParameters = function () {
      return [{
    ...
    LoanApplicationListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-loanapplication-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./loanapplication-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/loanapplications/loanapplication-list/loanapplication-list.component.html")).default,
      providers: [_shared_services_entity_state_service__WEBPACK_IMPORTED_MODULE_7__["EntityStateService"]],
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./loanapplication-list.component.scss */
      "./src/app/loanapplications/loanapplication-list/loanapplication-list.component.scss")).default]
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanapplicationTableLoanapplicationTableComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationListLoanapplicationTableLoanapplicationTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanApplicationTableComponent", function () {
      return LoanApplicationTableComponent;
    });
    /* harmony import */
    ...
    var LoanApplicationTableComponent =
    /*#__PURE__*/
    function () {
      function LoanApplicationTableComponent(router, route) {
        _classCallCheck(this, LoanApplicationTableComponent);
        ...
        this.isLoanApplicationsChanged$ = null;
        this.displayedColumns = ['loanApplicationId', 'productName', 'clientState', 'loanPurpose', 'loanAmount', 'firstName', 'lastName', 'phoneNumber', 'email', 'status'];
        this._loanApplicationView = '';
        ...
        this.dataSource.filterPredicate = function (data, filter) {
          ...
          var dataStr = data.status.toLowerCase().trim(); // ??? makarov  status loanapplications.status

          return dataStr.indexOf(filter) != -1;
        };
      }

      _createClass(LoanApplicationTableComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this4 = this;
          ...
          this.renderLoanApplicationList$ = this.dataSource.connect().asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (loanApplications) {
            // console.log('\tPIPE: LoanApplicationTableComponent.OnInit() renderLoanApplicationList:%O', loanApplications);
            _this4.renderLoanApplicationListChange.emit(loanApplications);
          }));
        }
      }, {
        key: "onTblRowClick",
        value: function onTblRowClick(loanApplication) {
    ...
    LoanApplicationTableComponent.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
      }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('data-source')], LoanApplicationTableComponent.prototype, "loanApplicationArr", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('loanapplication-view')], LoanApplicationTableComponent.prototype, "loanApplicationView", null);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('render-loanapplications')], LoanApplicationTableComponent.prototype, "renderLoanApplicationListChange", void 0);
    LoanApplicationTableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-loanapplication-table',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./loanapplication-table.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/loanapplications/loanapplication-list/loanapplication-table/loanapplication-table.component.html")).default,
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./loanapplication-table.component.scss */
      "./src/app/loanapplications/loanapplication-list/loanapplication-table/loanapplication-table.component.scss")).default]
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationInterfaceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WrongLoanApplication", function () {
      return WrongLoanApplication;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "WrongLoanApplicationList", function () {
      return WrongLoanApplicationList;
    });
    /* harmony import */
    ...
    var WrongLoanApplication = {
      loanApplicationId: '000000',
      productName: '000000',
      firstName: 'WRONG',
      lastName: 'WRONG'
    };
    var WrongLoanApplicationList = [WrongLoanApplication];
    /***/
  },
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanApplicationsRoutingModule", function () {
      return LoanApplicationsRoutingModule;
    });
    /* harmony import */
    ...
    var _loanapplication_list_loanapplication_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./loanapplication-list/loanapplication-list.component */
    "./src/app/loanapplications/loanapplication-list/loanapplication-list.component.ts");
    ...
    var LoanApplicationsRoutingModule = function LoanApplicationsRoutingModule() {
      _classCallCheck(this, LoanApplicationsRoutingModule);
    };

    LoanApplicationsRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [],
  ...
  /***/
  function srcAppLoanapplicationsLoanapplicationsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoanApplicationsModule", function () {
      return LoanApplicationsModule;
    });
    /* harmony import */
    ...
    var _shared_ng_material_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../shared/ng-material.module */
    "./src/app/shared/ng-material.module.ts");
    /* harmony import */


    var _loanapplications_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./loanapplications-routing.module */
    "./src/app/loanapplications/loanapplications-routing.module.ts");
    /* harmony import */


    var _loanapplication_list_loanapplication_table_loanapplication_table_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./loanapplication-list/loanapplication-table/loanapplication-table.component */
    "./src/app/loanapplications/loanapplication-list/loanapplication-table/loanapplication-table.component.ts");
    /* harmony import */


    var _loanapplication_list_loanapplication_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./loanapplication-list/loanapplication-list.component */
    "./src/app/loanapplications/loanapplication-list/loanapplication-list.component.ts");
    /* harmony import */


    var _loanapplication_list_loanapp_filter_settings_loanapp_filter_settings_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./loanapplication-list/loanapp-filter-settings/loanapp-filter-settings.component */
    "./src/app/loanapplications/loanapplication-list/loanapp-filter-settings/loanapp-filter-settings.component.ts");

    var LoanApplicationsModule = function LoanApplicationsModule() {
      _classCallCheck(this, LoanApplicationsModule);
    };

    LoanApplicationsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_loanapplication_list_loanapplication_list_component__WEBPACK_IMPORTED_MODULE_8__["LoanApplicationListComponent"], _loanapplication_list_loanapp_filter_settings_loanapp_filter_settings_component__WEBPACK_IMPORTED_MODULE_9__["LoanappFilterSettingsComponent"], _loanapplication_list_loanapplication_table_loanapplication_table_component__WEBPACK_IMPORTED_MODULE_7__["LoanApplicationTableComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_4__["MatRadioModule"], _shared_ng_material_module__WEBPACK_IMPORTED_MODULE_5__["NgMaterialModule"], _loanapplications_routing_module__WEBPACK_IMPORTED_MODULE_6__["LoanApplicationsRoutingModule"]]
    })], LoanApplicationsModule);
    /***/
  }
}]);
//# sourceMappingURL=loanapplications-loanapplications-module-es5.js.map